...
const OurStory = () => {
  return (
    <section id="about" className="py-20 bg-warm-yellow">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold mb-8 text-center text-warm-brown">
          Our Story
        </h2>
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2">
            <p className="text-lg mb-4 text-warm-brown">
