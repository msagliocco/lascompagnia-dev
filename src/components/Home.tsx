  ...
  return (
    ...
    >
      <div class="hidden sm:mb-8 sm:flex sm:justify-center">
        <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-white-600 ring-1 ring-orange-web hover:ring-white-900">
          #salvateculetto Smarrito Criceto a Bruxelles!{' '}
          <a href="#" class="font-semibold text-princeton-orange">
            <span aria-hidden="true" class="absolute inset-0"></span>Scopri di
